    ...
    <div class="container">
        ...
        <div class="topbar-left">
            ...
            <span class="topbar-brand fs-18 fw-400">
                <a class="logo-default text-dark" href="{{ route('welcome') }}" style="color: #563d7c">Assessment Suite</a>
                <a class="logo-inverse text-dark" href="{{ route('welcome') }}">Assessment Suite</a>
            </span>
        </div>
